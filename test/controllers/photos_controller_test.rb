...
class PhotosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "owner sees archive and metadata details" do
    ...
    assert_select "button[aria-label='Zoom in'][data-action='photo-zoom#zoomIn']"
    assert_select "button[aria-label='Hide zoom controls'][data-action='photo-zoom#hide']"
    assert_select "[data-photo-zoom-target='frame']"
