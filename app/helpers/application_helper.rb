module ApplicationHelper
  ...
  def photo_social_description(photo)
    photo.description.presence || photo_social_title(photo)
  end
  ...
  def app_icon(name, classes: "size-5")
    paths = {
      ...
      map_pin: '<path d="M20 10c0 4.5-8 12-8 12S4 14.5 4 10a8 8 0 1 1 16 0Z"/><circle cx="12" cy="10" r="3"/>',
      ...
      zoom_in: '<circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/><path d="M11 8v6"/><path d="M8 11h6"/>',
